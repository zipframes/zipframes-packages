...
import type { BrokerMessage, MessageHeaders, PublishOptions, Publisher } from "../types.js";
...
/**
 * In-process broker for unit tests and local experiments. Services still talk
 * to the same Publisher/Consumer interfaces they will use with RabbitMQ.
 */
...
export const createPublisher = (broker: {
  readonly publish: InMemoryBroker["publish"];
}): Publisher => ({
